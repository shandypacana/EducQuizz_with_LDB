...
class ScienceQuiz extends StatefulWidget {
  ...
  ScienceQuiz({required this.userName, required this.profileImage});

  @override
  _ScienceQuizState createState() => _ScienceQuizState();
}
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (context) => LeaderboardPage(category: 'Science'),
                  ),
                );
              },
              style: ElevatedButton.styleFrom(
